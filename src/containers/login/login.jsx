...
const Login = () => {
  ...
  // Use API handler without token for login (pass null)
  const { postData, loading, apiMessage } = useApiHandler(null);
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (!hasEmail) {
        const emailError = "Please enter your email!";
      ...
      try {
        // Use API handler with skipAuth = true since login doesn't need token
        const res = await postData("/auth/login", data, false, true);
      ...
      const validationError = "Please fill out the form correctly!";
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
      ...
      <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        <div className="lg:w-1/2 xl:w-6/12 p-6 sm:p-12">
          {/* Logo */}
          <div>
            <img src={"https://cdn-icons-png.flaticon.com/512/4661/4661334.png"} className="w-40 mx-auto" alt="Logo" />
          </div>
            ...
            >
              <div className=" w-full">
                <Form.Item
                  ...
                  required={true}
                  className="w-full"
                  labelCol={{ className: "font-medium text-gray-900" }}
                  rules={[
              ...
              <button
                ...
                class="mt-9 tracking-wide font-semibold bg-primary text-gray-100 w-full py-3 rounded-lg hover:bg-secondary hover:text-primary hover:border transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
              >
        ...
        <div className="flex-1 bg-secondary text-center flex">
          <div class="w-full bg-primary py-10 px-10">
            <svg
